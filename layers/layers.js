...
var lyr_FullColorPlantasgoogleearthWGS84 = new ol.layer.Image({
                            opacity: 1,
                            title: "Full Color Plantas google earth WGS84 ",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/FullColorPlantasgoogleearthWGS84.png",
                                projection: 'EPSG:3857',
                                alwaysInRange: true,
                                //imageSize: [1580, 943],
                                imageExtent: [-7669996.391491, -2554721.224545, -7666733.379545, -2552759.150001]
                            })
...
jsonSource_Domo.addFeatures(features_Domo);var lyr_Domo = new ol.layer.Vector({
                ...
                style: style_Domo,
                title: "Domo"
            });var format_PruebaGeoJsonOGRGeoJSONPolygon = new ol.format.GeoJSON();
var features_PruebaGeoJsonOGRGeoJSONPolygon = format_PruebaGeoJsonOGRGeoJSONPolygon.readFeatures(geojson_PruebaGeoJsonOGRGeoJSONPolygon, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PruebaGeoJsonOGRGeoJSONPolygon = new ol.source.Vector();
jsonSource_PruebaGeoJsonOGRGeoJSONPolygon.addFeatures(features_PruebaGeoJsonOGRGeoJSONPolygon);var lyr_PruebaGeoJsonOGRGeoJSONPolygon = new ol.layer.Vector({
                source:jsonSource_PruebaGeoJsonOGRGeoJSONPolygon, 
                style: style_PruebaGeoJsonOGRGeoJSONPolygon,
                title: "Prueba GeoJson OGRGeoJSON Polygon"
...
var group_Imagen = new ol.layer.Group({
                                layers: [lyr_FullColorPlantasgoogleearthWGS84],
                                title: "Imagen"});

lyr_FullColorPlantasgoogleearthWGS84.setVisible(true);lyr_Domo.setVisible(true);lyr_PruebaGeoJsonOGRGeoJSONPolygon.setVisible(true);lyr_StockPile.setVisible(true);lyr_RutasPlantas.setVisible(true);lyr_RutaBodega2.setVisible(true);lyr_Bodega5.setVisible(true);lyr_Bodega4.setVisible(true);lyr_Bodega3.setVisible(true);lyr_Bodega2.setVisible(true);lyr_Bodega1.setVisible(true);
var layersList = [baseLayer,group_Imagen,lyr_Domo,lyr_PruebaGeoJsonOGRGeoJSONPolygon,lyr_StockPile,lyr_RutasPlantas,lyr_RutaBodega2,lyr_Bodega5,lyr_Bodega4,lyr_Bodega3,lyr_Bodega2,lyr_Bodega1];
lyr_Domo.set('fieldAliases', {'id': 'id', 'Nombre': 'Nombre', 'fecha': 'fecha', 'capacidad': 'capacidad', 'EPP': 'EPP', });
lyr_PruebaGeoJsonOGRGeoJSONPolygon.set('fieldAliases', {'id': 'id', 'Nombre': 'Nombre', 'fecha': 'fecha', 'capacidad': 'capacidad', 'EPP': 'EPP', });
...
lyr_PruebaGeoJsonOGRGeoJSONPolygon.set('fieldImages', {'id': 'TextEdit', 'Nombre': 'TextEdit', 'fecha': 'TextEdit', 'capacidad': 'TextEdit', 'EPP': 'TextEdit', });
...
lyr_PruebaGeoJsonOGRGeoJSONPolygon.set('fieldLabels', {'id': 'no label', 'Nombre': 'no label', 'fecha': 'no label', 'capacidad': 'no label', 'EPP': 'no label', });
